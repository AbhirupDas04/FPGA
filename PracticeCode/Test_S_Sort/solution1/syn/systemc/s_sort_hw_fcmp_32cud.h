...
// ==============================================================
#ifndef __s_sort_hw_fcmp_32cud__HH__
#define __s_sort_hw_fcmp_32cud__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_sort_hw_fcmp_32cud) {
    ...
    SC_CTOR(s_sort_hw_fcmp_32cud):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
