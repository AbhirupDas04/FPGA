...
// ==============================================================
#ifndef __s_sort_hw_sitofp_bkb__HH__
#define __s_sort_hw_sitofp_bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_sort_hw_sitofp_bkb) {
    ...
    SC_CTOR(s_sort_hw_sitofp_bkb):  ACMP_sitofp_U ("ACMP_sitofp_U") {
