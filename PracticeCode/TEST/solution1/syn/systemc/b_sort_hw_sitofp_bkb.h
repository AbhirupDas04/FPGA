...
// ==============================================================
#ifndef __b_sort_hw_sitofp_bkb__HH__
#define __b_sort_hw_sitofp_bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(b_sort_hw_sitofp_bkb) {
    ...
    SC_CTOR(b_sort_hw_sitofp_bkb):  ACMP_sitofp_U ("ACMP_sitofp_U") {
