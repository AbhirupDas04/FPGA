...
// ==============================================================
#ifndef __chacha_hw_mul_50nibs__HH__
#define __chacha_hw_mul_50nibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(chacha_hw_mul_50nibs) {
    ...
    SC_CTOR(chacha_hw_mul_50nibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
