...
// ==============================================================
#ifndef __chacha_hw_mac_muljbC__HH__
#define __chacha_hw_mac_muljbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(chacha_hw_mac_muljbC) {
    ...
    SC_CTOR(chacha_hw_mac_muljbC):  simcore_mac_0_U ("simcore_mac_0_U") {
