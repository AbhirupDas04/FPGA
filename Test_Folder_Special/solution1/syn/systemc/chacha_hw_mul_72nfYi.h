...
// ==============================================================
#ifndef __chacha_hw_mul_72nfYi__HH__
#define __chacha_hw_mul_72nfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(chacha_hw_mul_72nfYi) {
    ...
    SC_CTOR(chacha_hw_mul_72nfYi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
