...
// ==============================================================
#ifndef __chacha_hw_mul_43ng8j__HH__
#define __chacha_hw_mul_43ng8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(chacha_hw_mul_43ng8j) {
    ...
    SC_CTOR(chacha_hw_mul_43ng8j):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
