...
if {[file isfile chacha_hw.autotvin.dat]} {
	file delete -force chacha_hw.autotvin.dat
}

if {[file isfile chacha_hw.autotvout.dat]} {
	file delete -force chacha_hw.autotvout.dat
}
