...
module AESL_autofifo_output_V_last_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.chacha_hw.autotvin_output_V_last_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.chacha_hw.autotvout_output_V_last_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 1;
parameter ADDR_WIDTH = 32'd 11;
parameter DEPTH = 32'd 750;
