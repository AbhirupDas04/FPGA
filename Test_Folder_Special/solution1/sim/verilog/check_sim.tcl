...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.chacha_hw.autotvin_input_V_data.dat"
         "c.chacha_hw.autotvin_input_V_last_V.dat"
         "c.chacha_hw.autotvin_output_V_data.dat"
         "c.chacha_hw.autotvin_output_V_last_V.dat"
         "c.chacha_hw.autotvout_output_V_data.dat"
         "c.chacha_hw.autotvout_output_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.chacha_hw.autotvout_output_V_data.dat"
         "rtl.chacha_hw.autotvout_output_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
