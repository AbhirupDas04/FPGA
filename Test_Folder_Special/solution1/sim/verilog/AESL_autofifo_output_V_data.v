...
module AESL_autofifo_output_V_data (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.chacha_hw.autotvin_output_V_data.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.chacha_hw.autotvout_output_V_data.dat";
