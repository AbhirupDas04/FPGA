...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Users/ABHIRUP-ACER/Downloads/Vivado/2019.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Users/ABHIRUP-ACER/Downloads/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Users/ABHIRUP-ACER/Downloads/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Users/ABHIRUP-ACER/Downloads/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Users/ABHIRUP-ACER/Downloads/Vivado/2019.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "chacha_hw.autotvin.dat"
	set constFileTvOut       "chacha_hw.autotvout.dat"
	set constFileHdlTvIn     "chacha_hw.autohdltvin.dat"
	set constFileHdlTvOut    "chacha_hw.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
