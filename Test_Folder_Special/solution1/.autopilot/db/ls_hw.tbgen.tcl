...
set C_modelName {ls_hw}
set C_modelType { void 0 }
set C_modelArgList {
	{ state_matrix int 8 regular {array 144 { 2 3 } 1 1 }  }
	{ index1 int 5 regular  }
	{ shift int 6 regular  }
	{ arr1 int 8 regular {array 8 { 2 3 } 1 1 }  }
	{ arr2 int 8 regular {array 32 { 2 0 } 1 1 }  }
	{ arr3 int 8 regular {array 32 { 2 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state_matrix", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "index1", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ arr2_address0 sc_out sc_lv 5 signal 4 } 
	...
	{ arr2_address1 sc_out sc_lv 5 signal 4 } 
	{ arr2_ce1 sc_out sc_logic 1 signal 4 } 
	{ arr2_we1 sc_out sc_logic 1 signal 4 } 
	{ arr2_d1 sc_out sc_lv 8 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "index1", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "index1", "role": "default" }} , 
 	...
 	{ "name": "arr2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "arr2", "role": "address0" }} , 
 	...
 	{ "name": "arr2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "arr2", "role": "address1" }} , 
 	{ "name": "arr2_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arr2", "role": "ce1" }} , 
 	{ "name": "arr2_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arr2", "role": "we1" }} , 
 	{ "name": "arr2_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "arr2", "role": "d1" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "arr1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convert_hex_to_binar_fu_343", "Port" : "hex"}]},
			{"Name" : "arr2", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convert_hex_to_binar_fu_343", "Port" : "bin"}]},
			{"Name" : "arr3", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_convert_hex_to_binar_fu_343", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "96", "Max" : "126"}
	, {"Name" : "Interval", "Min" : "96", "Max" : "126"}
]}
...
set Spec2ImplPortList { 
	...
	index1 { ap_none {  { index1 in_data 0 5 } } }
	...
	arr2 { ap_memory {  { arr2_address0 mem_address 1 5 }  { arr2_ce0 mem_ce 1 1 }  { arr2_we0 mem_we 1 1 }  { arr2_d0 mem_din 1 8 }  { arr2_q0 mem_dout 0 8 }  { arr2_address1 MemPortADDR2 1 5 }  { arr2_ce1 MemPortCE2 1 1 }  { arr2_we1 MemPortWE2 1 1 }  { arr2_d1 MemPortDIN2 1 8 } } }
	arr3 { ap_memory {  { arr3_address0 mem_address 1 5 }  { arr3_ce0 mem_ce 1 1 }  { arr3_we0 mem_we 1 1 }  { arr3_d0 mem_din 1 8 }  { arr3_q0 mem_dout 0 8 }  { arr3_address1 MemPortADDR2 1 5 }  { arr3_ce1 MemPortCE2 1 1 }  { arr3_q1 MemPortDOUT2 0 8 } } }
}
