...
set C_modelName {split_hw_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ key int 8 regular {array 24 { 1 1 } 1 1 }  }
	{ new_arr int 8 regular {array 24 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ new_arr_address0 sc_out sc_lv 5 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "new_arr_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "new_arr", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	new_arr { ap_memory {  { new_arr_address0 mem_address 1 5 }  { new_arr_ce0 mem_ce 1 1 }  { new_arr_we0 mem_we 1 1 }  { new_arr_d0 mem_din 1 8 } } }
}
