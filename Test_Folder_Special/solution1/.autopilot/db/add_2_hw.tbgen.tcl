...
set C_modelName {add_2_hw}
set C_modelType { void 0 }
set C_modelArgList {
	{ state_matrix int 8 regular {array 144 { 2 3 } 1 1 }  }
	{ copy_state_matrix int 8 regular {array 144 { 1 3 } 1 1 }  }
	{ index int 5 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "state_matrix", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "copy_state_matrix", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ copy_state_matrix_address0 sc_out sc_lv 8 signal 1 } 
	{ copy_state_matrix_ce0 sc_out sc_logic 1 signal 1 } 
	{ copy_state_matrix_q0 sc_in sc_lv 8 signal 1 } 
	{ index sc_in sc_lv 5 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "copy_state_matrix_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "copy_state_matrix", "role": "address0" }} , 
 	{ "name": "copy_state_matrix_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "copy_state_matrix", "role": "ce0" }} , 
 	{ "name": "copy_state_matrix_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "copy_state_matrix", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "arr1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convert_hex_to_binar_fu_341", "Port" : "hex"}]},
			{"Name" : "arr2", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_convert_hex_to_binar_fu_349", "Port" : "hex"}]},
			{"Name" : "arr3", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convert_hex_to_binar_fu_341", "Port" : "bin"}]},
			{"Name" : "arr4", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_convert_hex_to_binar_fu_349", "Port" : "bin"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_convert_hex_to_binar_fu_341", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_convert_hex_to_binar_fu_349", "Parent" : "0",
		"CDFG" : "convert_hex_to_binar",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set Spec2ImplPortList { 
	...
	copy_state_matrix { ap_memory {  { copy_state_matrix_address0 mem_address 1 8 }  { copy_state_matrix_ce0 mem_ce 1 1 }  { copy_state_matrix_q0 mem_dout 0 8 } } }
