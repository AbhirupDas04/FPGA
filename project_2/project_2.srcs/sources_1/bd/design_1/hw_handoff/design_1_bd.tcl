...
proc create_root_design { parentCell } {
  ...
  # Create instance: chacha_hw_0, and set properties
  set chacha_hw_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:chacha_hw:1.1 chacha_hw_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#Quad SPI Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#UART 1#UART 1#unassigned#unassigned#unassigned#unassigned} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins chacha_hw_0/input_r]
  ...
  connect_bd_intf_net -intf_net chacha_hw_0_output_r [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins chacha_hw_0/output_r]
